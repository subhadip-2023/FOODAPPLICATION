  ...
  return (
    <div className="navbar">
      ...
      <div className="navbar-right">
        ...
        {
          !token? <button className="Join-us-profile" onClick={() => setShowLogin(true)}>
            Sign In
              <div className="Join-us-profile-dropdown">
                <li onClick={navigate('/')}><p>Customer</p></li>
                <hr />
                <li onClick={navigate('/admin')}><p>Resturant</p></li>
              </div>
            </button> 
